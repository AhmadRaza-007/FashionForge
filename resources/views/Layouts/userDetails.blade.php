...
@section('content')
    ...
    @auth
        <form action="{{ route('user.completeOrder') }}" method="POST">
            <section>
                <div class="row container g-5 justify-content-center">
                    <div class="col-md-7 col-lg-8">
                        ...
                        <div class="needs-validation">
                            ...
                            <div class="mb-3">
                                <select class="form-select col-12" name="trans_type" id="trans_type">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12 position-relative">
                                    ...
                                    <div class="input" style="display: flex;justify-content: center;align-items: center;">
                                        <input type="tel" class="form-control pe-4" id="phone" name="phone_number"
                                            value="{{ old('phone_number', $address->phone ?? '') }}" placeholder="">
                            ...
                            <button class="w-100 btn btn-primary btn-lg" type="submit">Update Information</button>
                        </div>
                    </div>
                </div>
            </section>
