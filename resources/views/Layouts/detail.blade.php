            ...
            <div class="products_container_detail">
                @if ($isGift)
                    @foreach ($gifts as $key => $product)
                        ...
                        <form class="products_details_section" action="{{ route('user.check', $product->id) }}"
                            method="get">
                            @csrf
                            <div class="product_title  py-3">
                                ...
                                <div class="detail_section_buttons">
                                    <div class="detail_cart mt-5 mb-3">
                                        @if (!$isGift)
                                            <button type="submit" class="detail_button" name="action"
