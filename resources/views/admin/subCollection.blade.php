...
@section('content')
    <div class="container my-4">
        ...
        @if ($subName)
            <span>
                {{-- <h1 class="d-inline">{{ $subName->collection->name . ' Section' }}</h1> --}}
            </span>
        @endif
                    ...
                    <form method="post" action="{{ route('admin.addSubCollection') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3" style="text-align: left;">
                                ...
                                <input type="text" name="sub_collection_title" class="form-control"
                                    id="sub_collection_title" placeholder="Enter Collection" required>
                            </div>
                            <div class="mb-3" style="text-align: left;">
                                <label for="sub_collection_image_url" class="form-label">Link</label>
                                <input type="text" name="sub_collection_image_url" class="form-control"
                                    id="sub_collection_image_url" placeholder="Enter image url">
                            </div>
                            <!-- <div class="mb-3" style="text-align: left;">
                            ...
                            <div class="mb-3" style="text-align: left;">
                                ...
                                <input class="form-control" name="sub_collection_image" type="file"
                                    id="sub_collection_image" required multiple>
                            </div>
                        </div>
        ...
        <!-- Edit Modal -->
        <div class="modal fade" id="editSubCollectionModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content dash-card dash-card--yt">
                    <div class="modal-header">
                    ...
                    <form method="post" action="{{ route('admin.updateSubCollection') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            ...
                            <div class="mb-3" style="text-align: left;">
                                ...
                                <input type="text" name="sub_collection_title" class="form-control"
                                    id="edit_sub_collection_title" placeholder="Enter Collection" required>
                            </div>
                            <div class="mb-3" style="text-align: left;">
                                <label for="edit_sub_collection_image_url" class="form-label">Link</label>
                                <input type="text" name="sub_collection_image_url" class="form-control"
                                    id="edit_sub_collection_image_url" placeholder="Enter image url">
                            </div>
                            <div class="mb-3" style="text-align: left;">
                                <label for="sub_collection_image" class="form-label">Image</label>
                                <input class="form-control" name="sub_collection_image" type="file"
                                    id="sub_collection_image">
                            </div>
                            <div class="mb-3" style="text-align: left;">
