...
<div class="container my-4" style="min-width: 95%;">
    ...
    <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modalForCount" style="float: right;">
        Add Product
    </button>
        ...
        <div class="modal-dialog" style="max-width: 700px;">
            <div class="modal-content dash-card dash-card--fb">
                ...
                <form method="post" action="{{ route('admin.addClothes') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body" id="modal-body" style="display: grid;grid-template-columns: 48% 48%;justify-content: space-between;">
                        <div class="mb-3" style="text-align: left;">
                            <label for="collection_id" class="form-label">Sub Collections</label>
                            <select class="form-select" name="sub_collection_id" id="collection_id" aria-label="Default select example">
                        ...
                        <div class="mb-3" style="text-align: left;">
                            ...
                            <input type="text" name="product_name" class="form-control" id="product_name" placeholder="Enter Collection">
                            <span class="text-danger">
                                @error('product_name')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="mb-3" style="text-align: left;">
                            ...
                            <input type="text" name="product_details" class="form-control" id="product_details" placeholder="Enter Collection">
                            <span class="text-danger">
                        ...
                        <div class="mb-3" style="text-align: left;">
                            ...
                            <input type="text" name="product_fabric_details" class="form-control" id="product_fabric_details" placeholder="Enter Collection">
                            <span class="text-danger">
                            ...
                            <section class="ftco-section">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-lg-5 d-flex justify-content-center align-items-center" style="min-width: 100%;padding: 0;">
                                            <select class="js-select2 form-control" id="product_sizes" name="product_sizes[]" multiple="multiple">
                                                @foreach ($sizes as $size)
                                                <option value="{{ $size->id }}" data-badge="">{{ $size->size }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="mb-3" style="text-align: left;">
                            ...
                            <section class="ftco-section">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-lg-5 d-flex justify-content-center align-items-center" style="min-width: 100%;padding: 0;">
                                            <select class="js-select2 form-control" id="product_colors" name="product_colors[]" multiple="multiple">
                                                @foreach ($colors as $color)
                                                <option value="{{ $color->id }}" data-badge="">{{ $color->color }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="mb-3" style="text-align: left;">
                            ...
                            <input type="text" name="product_price" class="form-control" id="product_price" placeholder="Enter Collection">
                            <span class="text-danger">
                                @error('product_price')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="img_container mt-4" style="grid-column: span 2;">
                            <div class="container d-flex justify-content-between align-items-center py-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <button type="button" id="minusButton" class="btn btn-danger" style="border-radius: 5px 0 0 5px;"><i class="fa fa-minus"></i></button>
                                    <span id="input_length" style="background-color: white;color:black;padding: 0.2rem 0.7rem;"></span>
                                    <button type="button" id="plusButton" class="btn btn-danger" style="border-radius: 0 5px 5px 0;"><i class="fa fa-plus"></i></button>
                                </div>
                            </div>
                            <div class="plusButton" id="image_section">
                                <div class="plusButton" style="display: grid;grid-template-columns: 48% 48%;align-items: center;justify-content: space-between;">
                                    <div class="mb-3" style="text-align: left;">
                                        <label for="product_images" class="form-label">Product Images</label>
                                        <input class="form-control" name="product_images[]" type="file" id="product_images">
                                    </div>
            ...
            <div class="modal-content dash-card dash-card--fb">
                ...
                <form method="post" action="{{ route('admin.updateClothes') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body" id="modal-body" style="display: grid;grid-template-columns: 48% 48%;justify-content: space-between;">
                        <div class="mb-3" style="text-align: left;">
                            <label for="collection_id" class="form-label">Sub Collections</label>
                            <select class="form-select" name="edit_clothe_id" id="edit_clothe_id" aria-label="Default select example">
                        ...
                        <input type="hidden" name="clothe_id_hidden" class="form-control" id="clothe_id_hidden" placeholder="">
                        <div class="mb-3" style="text-align: left;">
                            <label for="edit_product_name" class="form-label">Product Name</label>
                            <input type="text" name="edit_product_name" class="form-control" id="edit_product_name" placeholder="Enter Collection">
                        </div>
                        <div class="mb-3" style="text-align: left;">
                            <label for="product_details" class="form-label">Product Details</label>
                            <input type="text" name="edit_product_details" class="form-control" id="edit_product_details" placeholder="Enter Collection">
                        </div>
                        <div class="mb-3" style="text-align: left;">
                            <label for="product_fabric_details" class="form-label">Product Fabric Detail</label>
                            <input type="text" name="edit_product_fabric_details" class="form-control" id="edit_product_fabric_details" placeholder="Enter Collection">
                        </div>
                        <div class="mb-3" style="text-align: left;">
                            ...
                            <section class="ftco-section">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-lg-5 d-flex justify-content-center align-items-center" style="min-width: 100%;padding: 0;">
                                            <select class="js-select2 form-control" id="edit_product_sizes" name="edit_product_sizes[]" multiple="multiple">
                                                @foreach ($sizes as $size)
                                                <option value="{{ $size->id }}" data-badge="">{{ $size->size }}</option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="size_container">
                                <ul class="select2-selection__rendered d-flex flex-wrap" id="editSizeDisplay" style="padding:0;">
                        ...
                        <div class="mb-3" style="text-align: left;">
                            ...
                            <section class="ftco-section">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-lg-5 d-flex justify-content-center align-items-center" style="min-width: 100%;padding: 0;">
                                            <select class="js-select2 form-control" id="edit_product_colors" name="edit_product_colors[]" multiple="multiple">
                                                @foreach ($colors as $color)
                                                <option value="{{ $color->id }}" data-badge="">{{ $color->color }}</option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="color_container">
                                <ul class="select2-selection__rendered d-flex flex-wrap" id="editColorDisplay" style="padding:0;">
                        ...
                        <div class="mb-3" style="text-align: left;">
                            <label for="product_size" class="form-label">Product Size</label>
                            <!-- <input type="text" name="product_size" class="form-control" id="product_size" placeholder="Enter Collection" > -->
                            <textarea name="edit_product_measurements" class="form-control" id="edit_product_measurements" cols="30" rows="10"></textarea>
                            @error('product_measurements')
                            {{ $message }}
                            @enderror
                            </span>
                        ...
                        <div class="mb-3" style="text-align: left;">
                            ...
                            <input type="text" name="edit_product_price" class="form-control" id="edit_product_price" placeholder="Enter Collection">
                        </div>
                        ...
                        <div class="img_container mt-4" style="grid-column: span 2;">
                            <div class="container d-flex justify-content-between align-items-center py-3">
                                <h4>Add more images</h4>
                                <div class="d-flex align-items-center">
                                    <button type="button" id="minusButton2" class="btn btn-danger" style="border-radius: 5px 0 0 5px;"><i class="fa fa-minus"></i></button>
                                    <span id="input_length2" style="background-color: white;color:black;padding: 0.2rem 0.7rem;"></span>
                                    <button type="button" id="plusButton2" class="btn btn-danger" style="border-radius: 0 5px 5px 0;"><i class="fa fa-plus"></i></button>
                                </div>
                            </div>
                            <div class="plausButton" id="image_section2">
                                <div class="plusButton" style="display: grid;grid-template-columns: 48% 48%;align-items: center;justify-content: space-between;">
                                    <div class="mb-3" style="text-align: left;">
                                        ...
                                        <input class="form-control" name="edit_product_images[]" type="file" id="edit_product_images">
                                    </div>
                                    <div class="mb-3 url_fields" style="text-align: left;" id="url_fields">
                    ...
                    <tr class="row1" data-id="{{ $product -> name }}" style="text-align: left;">
                        ...
                        <td class="d-flex">
                            ...
                            <div class="image_container" style="width: 100px;float:left; position:relative;">
                                <a class="btn delete btn-sm image_delete_btn" href="{{ url('/admin/delete/clotheImage' . '/' . $image->id) }}" style="position: absolute; background: black;right:0;">
                                    <i class="fas fa-trash-alt delete_image" style="color: var(--clr-youtube);"></i>
                                </a>
                                <img src="{{ asset($image->product_images) }}" width="100" height="100" alt="" class="product_image">
                            </div>
                            @endforeach
                        </td>
                        <td>
                        ...
                        <td>
                            <a class="btn btn-sm" onclick="editCollection({{$product->id}})" data-bs-toggle="modal" data-bs-target="#editProductModal" data-bs-target="#editProductModal">
                                <i class="fas fa-edit" style="color: skyblue;"></i>
                            </a>
                            <a class="btn delete btn-sm" href="{{ url('/admin/delete/clothes' . '/' . $product->id) }}">
